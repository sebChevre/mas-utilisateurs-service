package ch.globaz.utilisateursservice.application;

import ch.globaz.utilisateursservice.application.configuration.DefaultProfileUtil;
import ch.globaz.utilisateursservice.application.configuration.Profiles;
...
@ComponentScan(basePackages = "ch.globaz.utilisateursservice")
